/* 
Header used inside TransactionForm.tsx
Conditionaly render the title based on the transaction nature or the mode(create|edit)
*/
    ...
    return (
      <DialogHeader>
        ...
        <DialogDescription>
          ...
          {txNature.charAt(0).toUpperCase() + txNature.slice(1)} Transaction
        </DialogDescription>
      </DialogHeader>
    );
  }
