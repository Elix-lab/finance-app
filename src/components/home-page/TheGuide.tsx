function TheGuide() {
  return (
    <section className="py-12 px-4 flex flex-col gap-5 items-center m-auto max-w-2xl lg:max-w-4xl lg:grid lg:grid-cols-2 xl:max-w-6xl">
      <div className="flex flex-col gap-5 col-start-2">
        ...
        <p className="text-base text-muted-foreground text-center text-balance lg:text-start">
          Life gets busy. Expenses add up. And before you notice, money becomes
          another source of stress. This app was built to help staying on top of
          your finances feel simpler and less overwhelming.
        </p>
      </div>
      <img
